...
pasta = 'imgs_geradas/5cigarro/charuto.png'
...
class Charuto:
    ...
    def __init__(self, x, y):
        ...
        def geraPixels(matriz,
            ...
            matriz[30, 17:18] = cigarro
            matriz[30, 18:19] = cigarrodetalhe
            matriz[30, 19:20] = cigarro
            ...
            matriz[32, 15:16] = cigarro
            matriz[32, 16:17] = cigarrodetalhe
            matriz[32, 17:18] = cigarro
            matriz[32, 18:60] = branco

            matriz[33, 0:11] = branco
            matriz[33, 11:13] = fumaca
            matriz[33, 13:14] = branco
            matriz[33, 14:15] = cigarrodetalhe
            matriz[33, 15:16] = cigarro
